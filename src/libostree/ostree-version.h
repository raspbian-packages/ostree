 ...
 * Since: 2017.4
 */
#define OSTREE_VERSION_S "2023.8"
...
#define OSTREE_BUILT_FEATURES "inode64 libsoup3 gpgme composefs ex-fsverity libarchive selinux libmount systemd release p2p"
#endif
